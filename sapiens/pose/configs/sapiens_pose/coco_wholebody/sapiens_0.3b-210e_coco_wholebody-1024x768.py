...
pretrained_checkpoint='/home/arthur/sapiens_fine_tune/sapiens_host/pretrain/checkpoints/sapiens_0.3b/sapiens_0.3b_epoch_1600_clean.pth'
...
bbox_file = "/home/arthur/sapiens_fine_tune/coco_dataset/person_detection_results/COCO_val2017_detections_AP_H_70_person.json"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='data/coco',
        data_mode='topdown',
        ann_file='/home/arthur/sapiens_fine_tune/coco_dataset',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoWholeBodyDataset',
        data_root='/home/arthur/sapiens_fine_tune/coco_dataset',
        data_mode='topdown',
...
val_evaluator = dict(
    ...
    ann_file='/home/arthur/sapiens_fine_tune/SapiensCopy/coco_dataset/annotations/coco_wholebody_val_v1.0.json')
